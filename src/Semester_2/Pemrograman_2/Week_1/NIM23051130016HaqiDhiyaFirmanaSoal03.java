...
public class NIM23051130016HaqiDhiyaFirmanaSoal03 {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Rata - rata bilangan acak(A) : " + calculateAverage(numbers));
        System.out.println("Rata - rata bilangan acak(B) : " + calculateAverage(oddNumbers));
        System.out.println("Rata - rata bilangan acak(C) : " + calculateAverage(evenNumbers));
    }
